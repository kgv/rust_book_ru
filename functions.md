...
Каждая программа на Rust имеет по крайней мере одну функцию, функцию `main`:
...
Здесь показаны две интересные особенности Rust'а. Во-первых, это выражение-
...
оператор `х + 1;` не возвращает значение. Есть два типом операторов в Rust:
‘операторы объявления‘ и ‘операторов выражение‘. Все остальное - выражения.
Давайте поговорим о операторах объявления в первую очередь.
...
превратить любое выражение в оператор. В практическом плане, грамматика Rust'а
