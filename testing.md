...
Мы можем обратить ожидаемый результат теста с помощью атрибута: `should_fail`:
...
А теперь этот тест будет выполнен успешно или неудачно? Из-за атрибута `should_fail` он завершится успешно:
