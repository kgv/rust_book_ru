...
Хотя иногда этого не достаточно. Например, все эти примеры кода с `///` мы говорим о? Представленный ниже блок кода до обработки `rustdoc`, в виде простого текста:
