...
индексацией вектора. Во-вторых, этот версия является более эффективной: первая
...
Если вы попытаетесь выполнить замыкание для итератор для своих побочных
эффектов, вместо этого просто используйте `for`.
...
попробуем применить его для бесконечного итератора `count()`, рассмотренного
прежде:
