...
видимости владельца. Во-вторых, одновременно вы можете использовать лишь какой-
либо один из этих двух видов заема, но не оба сразу:

* от 0 до N неизменяемых ссылок (`&T`) на ресурс,
* ровно одну изменяемую ссылку (`&mut T`) на ресурс.
