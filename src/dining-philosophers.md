...
> еще и вилка справа от него. Философы положили свои вилки и встали из-за стола,
...
Теперь мы можем начать моделирование задачи. Начнем с философов в `src/main.rs`:
...
Здесь мы связываем пять имен переменных с пятью новыми философами. Если бы
...
между взятием первой и втрой вилки, поскольку этот процесс не моментален.
...
порядок параметров, то программа попадет в безвыходное состояние.
