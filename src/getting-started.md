...
«Всем привет!», и, наконец, поговорим о Cargo, который представляет из себя
...
программа просто выводит на экран «Всем привет!», и мы следуем этой традиции.
...
вы должны увидеть строку `Всем привет!` в терминале. Поздравляем! Вы написали
первую программу на Rust. Теперь вы Rust-разработчик! Добро пожаловать!

## Анатомия программ на Rust

Теперь давайте детально разберемся, что происходит в программе "Всем привет!".
...
Идём дальше. `"Всем привет!"` — это «строка». Строки — это удивительно сложная
...
```
Мы вывели наш текст `"Всем привет!"` в окне терминала.
...
Давайте переведем наш проект "Всем привет" на использование Cargo. Для перехода
