...
модификатор `unsafe` отсутствует в сигнатуре функции.
...
заимствования или изменяемости может быть опасным, поэтому используйте сырые
указатели (`*`), если вам необходимо обойти эти правила. Компилятор не может
сделать так много предположений о сырых указателях, поэтому обход правил
