...
Обобщённым программированием в теории типов называется «параметрический
полиморфизм». Это означает, что типы или функции имеют несколько форм (poly —
...
Обобщать можно больше, чем по одному параметру. Рассмотрим другой обобщённый тип
