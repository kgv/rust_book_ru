...
Многие новые пользователи Rust испытывают то, что мы называем «борьба с
...
Вы, наверное, также будете испытывать подобные трудности поначалу. Однако
...
Во-первых, область видимости любого займа должна находиться в пределах области
...
становится недействительной. Таким образом, ошибка сообщает, что заиствование
«does not live long enough» («не живет достаточно долго»), потому что он не
