...
Время жизни с именем «static» особенно. Оно обозначает, что что-то имеет время
жизни, равное времени жизни всей программы. Большинство программистов на Rust
впервые сталкиваются с `'static`, когда имеют дело со строками:
